...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
	    ...
	    if (isset($this->request->post['customImage'])) {
	        $data['customImage'] = $this->request->post['customImage'];
	    } elseif (!empty($product_info)) {
	        $data['customImage'] = $this->model_catalog_product->getProductCustomImage($this->request->get['product_id']);
	    } else {
	        $data['customImage'] = '';
	    }
	    ...
	    if (isset($this->request->post['customImage']) && is_file(DIR_IMAGE . $this->request->post['customImage'])) {
	        $data['thumbcustomImage'] = $this->model_tool_image->resize($this->request->post['customImage'], 100, 100);
	    } elseif (!empty($product_info) && is_file(DIR_IMAGE . $data['customImage'])) {
	        $data['thumbcustomImage'] = $this->model_tool_image->resize($data['customImage'], 100, 100);
	    } else {
	        $data['thumbcustomImage'] = $this->model_tool_image->resize('no_image.png', 100, 100);
	    }
	    /////////////////////////
