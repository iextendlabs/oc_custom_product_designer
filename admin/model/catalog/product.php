...
class ModelCatalogProduct extends Model {
    ...
    public function getProductCustomImage($product_id) {
      $query = $this->db->query("SELECT image FROM " . DB_PREFIX . "product_to_customimage  WHERE product_id = '" . (int)$product_id . "'");
	...
	public function editProduct($product_id, $data) {
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "product_to_customimage WHERE product_id = '" . (int)$product_id . "'");
        ...
        if (isset($data['product_custom'])) {
          foreach ($data['product_custom'] as $product_custom) {
            $this->db->query("INSERT INTO " . DB_PREFIX . "product_custom_fields SET product_id = '" . (int)$product_id . "', label = '" . $this->db->escape($product_custom['label']) . "',default_text = '" .$product_custom['default_text'] . "', family = '" .$product_custom['family'] . "',size = '" .(int)$product_custom['size'] . "',color = '" .$product_custom['color'] . "', position_x = '" . $this->db->escape($product_custom['position_x']) . "', position_y = '" . $this->db->escape($product_custom['position_y']) . "', max_length = '" . $this->db->escape($product_custom['max_length']) . "', opacity = '" . (float)$product_custom['opacity'] . "', height = '" . (int)$product_custom['height'] . "', width = '" . (int)$product_custom['width'] . "', required = '" . (int)$product_custom['required'] . "'");
          }
        }
        ///////////////////////
    ...
    public function getProductCustomFields($product_id) {
      $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_custom_fields WHERE product_id = '" . (int)$product_id . "' ORDER BY product_custom_id ASC");
